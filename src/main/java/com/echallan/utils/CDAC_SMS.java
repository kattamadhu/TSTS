...
@Service
public class CDAC_SMS {

	private final static String userName="HYDPOL";
	private final static String password="hydpol@5803";
	private final static String sendeId="HYDPOL";
	private final static String secureKey="033987e8-7364-429c-ab6d-85ae044c2c40";
	...
	public String sendSingleSMS(String mobileNo, String message){
		...
		try {
			...
			String genratedhashKey = hashGenerator(userName, sendeId, message, secureKey);
			List<NameValuePair> nameValuePairs=new ArrayList<NameValuePair>(1);
			nameValuePairs.add(new BasicNameValuePair("mobileno", mobileNo));
			nameValuePairs.add(new BasicNameValuePair("senderid", sendeId));
	 ...
	 */
	@Transactional
	public String sendBulkSMS(String mobileNo, String message){
	 ...
	 * @param username : Department Login User Name
	 * @param password : Department Login Password
	 * @param message  : Unicode Message e.g. 'ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚ÂµÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¿ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ¢â‚¬Â¢ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¾ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¸ ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ¢â‚¬Â ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â£ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¿ ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚ÂªÃƒÆ’ Ãƒâ€šÃ‚Â¥Ãƒâ€šÃ‚ÂÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â°ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ¢â‚¬â€ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¤ ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¸ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ¢â‚¬Å¡ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ¢â‚¬â€ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â£ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¨ ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ¢â‚¬Â¢ÃƒÆ’ Ãƒâ€šÃ‚Â¥Ãƒâ€šÃ¢â‚¬Â¡ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ¢â‚¬Å¡ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¦ÃƒÆ’ Ãƒâ€šÃ‚Â¥Ãƒâ€šÃ‚ÂÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â° ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â®ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â§ÃƒÆ’ Ãƒâ€šÃ‚Â¥Ãƒâ€šÃ‚ÂÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¯ÃƒÆ’ Ãƒâ€šÃ‚Â¥Ãƒâ€šÃ¢â‚¬Â¡ ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¸ÃƒÆ’ Ãƒâ€šÃ‚Â¥Ãƒâ€šÃ‚ÂÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚ÂµÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¾ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ¢â‚¬â€ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¤ ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ¢â‚¬Â ÃƒÆ’ Ãƒâ€šÃ‚Â¤Ãƒâ€šÃ‚Â¹ÃƒÆ’ Ãƒâ€šÃ‚Â¥Ãƒâ€šÃ¢â‚¬Â¡'
	 * @param senderId	: Department allocated SenderID
	 * @param mobileNumber : Bulk Mobile Number with comma separated e.g. '99XXXXXXX,99XXXXXXXX' 
	 * @param secureKey :  Department key generated by login to services portal
	 * @return {@link String} response from Mobile Seva Gateway e.g. '402,MsgID = 150620161466003974245msdgsms' 
	 ...
	 */
	@Transactional
	public String sendMultiLangSMS(String mobileNo, String message){
		...
		try {
			...
			HttpPost post=new HttpPost("https://msdgweb.mgov.gov.in/esms/sendsmsrequest");
			encryptedPassword  = MD5(password);
			String genratedhashKey = hashGenerator(userName, sendeId, finalmessage, secureKey);
			List<NameValuePair> nameValuePairs=new ArrayList<NameValuePair>(1);
			nameValuePairs.add(new BasicNameValuePair("bulkmobno", mobileNo));
			nameValuePairs.add(new BasicNameValuePair("senderid", sendeId));
	...
	@Transactional
	public String sendOTPSMS (String mobileNo, String message){
	 ...
	 */
	@Transactional
	public String sendMultiLangOTPSMS(String mobileNo, String message){
